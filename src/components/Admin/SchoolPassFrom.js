...
import {Button, Form, Input, message, Icon, Layout, Select } from 'antd';
import {$axios, navPage} from "../../utils";

const {TextArea} = Input;
const FormItem = Form.Item;

class SchoolPassFrom extends React.Component {
            ...
            <Form onSubmit={this.handleSubmit} autoComplete='false'>
                ...
                >
                        {getFieldDecorator('old_user_pass', {
                            ...
                            <Input style={{margin:"initial",width:"180px"}} type="text" placeholder="请输入旧密码"/>
                        )}
                </FormItem>   
                <FormItem
                    {...formItemLayout}
                ...
                >
                        {getFieldDecorator('user_pass', {
                            ...
                            <Input onBlur={this.handleConfirmBlur} style={{margin:"initial",width:"180px"}} type="text" placeholder="请输入6-16位密码"/>
                        )}
                </FormItem>
                <FormItem
                    {...formItemLayout}
                ...
                >
                        {getFieldDecorator('confirm_pass', {
                             rules: [{
                                min: 6, max: 20, message: '请输入6-16位确认密码',
                            }, {
                            ...
                            <Input style={{margin:"initial",width:"180px"}} type="text" placeholder="请再次输入密码"/>
                        )}
                </FormItem>
