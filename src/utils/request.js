...
const map=["thd","txx","tcj","thhht","tzs","tly","thz","twh","tmzl","tbt","thlbe","tsx","tqd","txy","tsy","tshaoxing","theb","tsz"];

// config axios request
// 生产环境，测试环境和本地环境
const Config = {
    proFix: "http://www.uonestem.com/index.php",
    devPrefixOne: "http://114.55.89.35:8080/index.php",
    localRequestUrl:"http://114.55.89.35:8080/index.php",
    devPrefixTwo:"http://114.55.89.35:8081/index.php",
    proUpgrade:"http://hd.uonestem.com"
};
...
//升年级
var UpgradeUrl = Config.devPrefixOne;
...
if(href.indexOf("localhost")>=0){
    ...
    UpgradeUrl = Config.localRequestUrl;
}
...
// 公办test请求地址配置
if (href.indexOf("114.55.89.35:8083")>=0){
    axios.defaults.baseURL = Config.devPrefixOne;
    UpgradeUrl = Config.devPrefixOne;
};

// 公办请求地址
//
console.log("公办请求情况：",map.indexOf(_mapUrl));
if(map.indexOf(_mapUrl)>=0){
    axios.defaults.baseURL="http://api.uonestem.com/index.php";
    UpgradeUrl = Config.proUpgrade;
