    ...
    componentDidMount() {
        ...
        $axios('/Eduunit/EduunitCourse/course_index').then(data => {
            ...
            if (data.ret_code === '0000000' && data.ret_data.course) {
                console.log("item:",data.ret_data.course);
                                                    ...
                                                    <li>
                                                        <div className="header3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <a 
                                                                    href={item2.courseware_doc}
                                                                    target="_blank"
                                                                   >文档课件</a>
                                                                }
                                                                {item2.courseware_video !== '0' &&
                                                                <a onClick={this.handleVideoCourse.bind(this,item2.courseware_video,item2.courseware_name)} >视频课件</a>
                                                                }
                                                            </div>
                                                        </div>
                                                    </li>
